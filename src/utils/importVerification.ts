...
import { FUM_VAULT_CONFIG, SUPPORTED_TOKENS } from '../contracts/FUMVault'
...
// Test hook imports
import { useFUMVault } from '../hooks/contracts/useFUMVault'
...
export const verifyImports = () => {
  ...
  // Test hooks exist
  console.log('✅ useFUMVault:', typeof useFUMVault)
